...
public class CurrencyMapperTest {
    ...
    String responseJson = "{\"base\":\"GBP\",\"date\":\"2016-07-01\",\"rates\":{\"USD\":1.3283,\"EUR\":1.4322}}";
    GBPExchangeRate expectedGBPExchangeRate = new GBPExchangeRate(new BigDecimal(1.3283), new BigDecimal(1.4322));
